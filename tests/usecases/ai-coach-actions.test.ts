  ...
  getTrainingIntelligenceBundle: vi.fn(async () => ({
    ...
    plan: {
      ...
      plan: {
        ...
        actionType: "DRILL",
        objectiveKey: "trainingIntel.developing.action",
        objectiveVars: {},
        reasons: [{ key: "trainingIntel.developing.evidence", vars: { stage: "introduced" } }],
        evidence: [{ key: "trainingIntel.developing.evidence", vars: { stage: "introduced" } }],
        relatedSkills: [],
      },
    },
  })),
