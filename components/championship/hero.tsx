...
export function ChampionshipHero({
  ...
  return (
    <div
      className={cn(
        "relative isolate overflow-hidden rounded-2xl bg-[oklch(0.14_0_0)] p-6 sm:p-8 md:min-h-[280px]",
        className
      )}
    >
      ...
      <div className="relative flex flex-col gap-3 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-left-4 motion-safe:duration-700">
        ...
        <h2 className="max-w-md text-3xl font-black uppercase leading-[1.05] tracking-tight text-[oklch(0.78_0.13_82)] sm:text-4xl">
          {headline}
        </h2>
        {children}
      </div>
