    ...
    <form action={formAction} className="flex flex-col gap-3 rounded-lg border border-border p-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_name">Nom du cours</Label>
          <Input id="class_name" name="name" maxLength={120} required />
        </div>
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_group">Groupe (optionnel)</Label>
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_day">Jour récurrent (optionnel)</Label>
        ...
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_start_time">Heure de début</Label>
          <Input id="class_start_time" name="start_time" type="time" />
        </div>
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_duration">Durée (minutes)</Label>
          <Input id="class_duration" name="duration_minutes" type="number" min={1} />
        </div>
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="class_capacity">Capacité (optionnel)</Label>
