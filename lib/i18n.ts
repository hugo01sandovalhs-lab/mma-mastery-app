...
const fr = {
  ...
  "nav.profile": "Profil", "nav.calendar": "Calendrier", "nav.menu": "Menu",
...
export const DICTIONARIES: Record<Locale, Dictionary> = {
  ...
  en: {
    ...
    "nav.search": "Search", "nav.profile": "Profile", "nav.calendar": "Calendar", "nav.menu": "Menu",
    ...
    "page.search.title": "Search", "page.profile.title": "Profile",
  },
  es: {
    ...
    "nav.search": "Buscar", "nav.profile": "Perfil", "nav.calendar": "Calendario", "nav.menu": "Menú",
    ...
    "page.search.title": "Buscar", "page.profile.title": "Perfil",
  },
  de: {
    ...
    "nav.search": "Suche", "nav.profile": "Profil", "nav.calendar": "Kalender", "nav.menu": "Menü",
    ...
    "page.search.title": "Suche", "page.profile.title": "Profil",
  },
};
